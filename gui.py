...
label = tk.Label(root, text=" 🍔 Welcome to your Food Truck Manager 🍔", bg="light blue")
label.pack(pady=10)
root.configure(bg='light blue')

label_orders = tk.Label(root, text="Pending Orders: " + str(len(Order_list)), bg="light blue")
label_orders.pack(side=BOTTOM, pady=10)
...
place_order_button = tk.Button(root, text="Place Order", width=20, height=2, command=create_order)
place_order_button.pack(pady=10)

# Button to check order list
check_order_button = tk.Button(root, text="Check Order", width=20, height=2, command=orders_page)
check_order_button.pack(pady=10)

# Button to pay
pay_button = tk.Button(root, text="Pay", width=20, height=2, command=customer_payment)
